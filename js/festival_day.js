...
if(m==10&&dd<=5){//国庆节
    console.log("今天是国庆"+(y-1949).toString()+"周年！");
    if(getCookie("isPopupWindow")!="1"){
        Swal.fire("今天是国庆"+(y-1949).toString()+"周年！","","success");
        setCookie("isPopupWindow","1",1);
    }
}
if(m==8&&dd==15){//搞来玩的，鬼子投降
    console.log("今天是日本宣布终战诏书第"+(y-1945).toString()+"年！");
    if(getCookie("isPopupWindow")!="1"){
        Swal.fire("今天是日本宣布终战诏书第"+(y-1945).toString()+"年！","","success");
        setCookie("isPopupWindow","1",1);
    }
}
if(m==1&&dd==1){//元旦节
    ...
    if(getCookie("isPopupWindow")!="1"){
        Swal.fire(y.toString()+"年元旦快乐！","","success");
        setCookie("isPopupWindow","1",1);
    }
}
if(m==3&&dd==8){//妇女节
...
if(m==5&&dd==1){//劳动节
    ...
    if(getCookie("isPopupWindow")!="1"){
        Swal.fire("劳动节快乐！为助力各行各业发展辛勤工作的人们致敬！","","success");
        setCookie("isPopupWindow","1",1);
    }
}
if(m==5&&dd==1){//劳动节
...
if(m==5&&dd==4){//青年节
    ...
    if(getCookie("isPopupWindow")!="1"){
        Swal.fire("为有思想政治觉悟，拥护中国共产党，追求无产阶级、共产主义、马克思主义的青年们致敬","","success");
        setCookie("isPopupWindow","1",1);
    }
}
if(m==6&&dd==1){//儿童节
    console.log("各位朋友们，儿童节快乐！");
    if(getCookie("isPopupWindow")!="1"){
        Swal.fire("各位朋友们，儿童节快乐！","","success");
        setCookie("isPopupWindow","1",1);
    }
}
if(m==7&&dd==1){//建党节
    ...
    if(getCookie("isPopupWindow")!="1"){
        Swal.fire("中国共产党"+(y-1921).toString()+"岁生日快乐","","success");
        setCookie("isPopupWindow","1",1);
    }
}
if(m==8&&dd==1){//建军节
    if(getCookie("isPopupWindow"!="1")){
        Swal.fire("中国人民解放军建军"+(y-1927).toString()+"周年快乐","","success");
        setCookie("isPopupWindow","1",1);
    }
}
if(m==9&&dd==15||(m==9&&dd==16)){//建站纪念日前夕
      Swal.fire("欢迎来到"+(y-2021).toString()+"周岁的小站<br>周年庆快乐！","","success");
}

if(m==12&&dd==25){//圣诞节
    if(getCookie("isPopupWindow"!="1")){
        Swal.fire("圣诞节快乐","","success");
        setCookie("isPopupWindow","1",1);
    }
}
...
if((lunar["IMonthCn"]=="正月"&&lunar["IDayCn"]=="初六")||(lunar["IMonthCn"]=="正月"&&lunar["IDayCn"]=="初五")||(lunar["IMonthCn"]=="正月"&&lunar["IDayCn"]=="初四")||(lunar["IMonthCn"]=="正月"&&lunar["IDayCn"]=="初三")||(lunar["IMonthCn"]=="正月"&&lunar["IDayCn"]=="初二")||(lunar["IMonthCn"]=="正月"&&lunar["IDayCn"]=="初一")||(lunar["IMonthCn"]=="腊月"&&lunar["IDayCn"]=="三十")||(lunar["IMonthCn"]=="腊月"&&lunar["IDayCn"]=="廿九")){
    ...
    if(getCookie("isPopupWindow")!="1"){
        Swal.fire(y.toString()+"年新年快乐！","","success");
        setCookie("isPopupWindow","1",1);
    }
}
