	        ...
	        success:function(data){
                ...
                var showFPS = (function(){ 
                    ...
                    appendFps = function(fps){ 
                        ...
                        p.ping("https://www.gmit.vip", function(perr, ping) {
                            if(perr){
                                $('#fps').html('<span style="float:right; color:black">'+fps+'FPS</span><br/><span style="float:right; color:black">'+window.info.data.os+'</span><br/><span style="float:right;margin-top:1px; color:black">'+window.info.data.browser+'</span><br/><span style="float:right;margin-top:1px;color:black">'+window.info.data.location+''+ping+'ms</span>');
                            }
                            if(ping){
                                $('#fps').html('<span style="float:right; color:black">'+fps+'FPS</span><br/><span style="float:right; color:black">'+window.info.data.os+'</span><br/><span style="float:right;margin-top:1px; color:black">'+window.info.data.browser+'</span><br/><span style="float:right;margin-top:1px; color:black">'+window.info.data.location+' '+ping+'ms</span>');
                            }
