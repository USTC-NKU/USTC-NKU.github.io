 ...
 */
  ...
  const rightSideFn = {
    switchReadMode: () => { // read-mode
      ...
      // newEle.type = 'button'
      // newEle.className = 'fa fa-sign-out-alt exit-readmode'
    ...
    switchDarkMode() {
      // const nowMode = document.documentElement.getAttribute('data-user-color-scheme') === 'dark' ? 'dark' : 'light'
      // if (nowMode === 'light') {
      //   activateDarkMode()
      //   saveToLocal.set('Fluid_Color_Scheme', 'dark')
      //   GLOBAL_CONFIG.Snackbar !== undefined && btf.snackbarShow(GLOBAL_CONFIG.Snackbar.day_to_night)
      // } else {
      //   activateLightMode()
      //   saveToLocal.set('Fluid_Color_Scheme', 'light')
      //   GLOBAL_CONFIG.Snackbar !== undefined && btf.snackbarShow(GLOBAL_CONFIG.Snackbar.night_to_day)
      // }
      const transboard = document.getElementById("board")
      if(transboard.getAttribute("boardtrans")!="true" || transboard.hasAttribute("boardtrans")==false){
        transboard.setAttribute("boardtrans","true")
        transboard.style.setProperty("background","transparent")
      }
      else if(transboard.getAttribute("boardtrans")=="true"){
        transboard.setAttribute("boardtrans","false")
        transboard.style.removeProperty("background")
