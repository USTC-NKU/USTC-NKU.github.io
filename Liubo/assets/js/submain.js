...
(function ($) {
    ...
    */
    $.launch_date = [1, 1, 2023]; 										//-- launch date [d,m,yyyy], for example 7 September 2016 : [7,9,2016]
    $.bg_urls = ["", ""];
    ...
    $.map_marker_url = "/img/ogol.png"; 							//-- Map marker image url
    ...
    $.wordrotator_words = ['<h4>Behold a high mountain  with awe</h4>', '<h4>What is past is prologue</h4>', '<h4>To the vast and subtle</h4>', '<h4>Remain true to our original aspiration</h4>']; //-- Array of words, for headline text
