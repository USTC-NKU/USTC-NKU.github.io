    ...
    methods: {
      ...
      initRuntime: function (first) {
        ...
        if (first && !YL.static.serialNumber) {
          YL.onReady(function () {
            setTimeout(function () {
              YL.msg("USTC-茶糜花开" + YL.info.version + "提示", '当前页面为导航控制中心<br/>更多内容请访问:<br/>小U主网：' + '<a style="color: white" target="_blank" href="https://blog.starysky.top">https://blog.starysky.top</a><p>欢迎使用微信扫描二维码订阅微信号，持续关注后续更新~<br/><br/><img style="width: 100%" src="./res/img/donation.png"/></p>');
            }, 1500)
          });
        }
